...
import com.jd.jdkit.elementkit.utils.common.ImageLoadUtils;
import com.jd.jdkit.elementkit.utils.common.QiNiuUpLoadUtils;
...
//                .build();
     ...
     * 配置七牛图片云存储
     */
    public AppInitUtils initQiNiuUpLoad(String externalLinks) {
        QiNiuUpLoadUtils.externalLinks = externalLinks;
        return this;
    }
