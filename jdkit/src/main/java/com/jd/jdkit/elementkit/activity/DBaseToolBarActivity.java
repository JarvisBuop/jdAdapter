 ...
 * Usage:    添加toolbar,注意屏幕适配 v21 设置padding和theme;
 */
public abstract class DBaseToolBarActivity extends AppCompatActivity {
    ...
    protected void setBackBtn() {
        if (back != null) {
            ...
            LogUtils.eLoger(TAG, "back is null ,please check out");
        }
    ...
    public void setContentView(View view) {
        ...
        initToolbar();//这句不写,设置布局后无法获取toolbar中的控件;
    }
