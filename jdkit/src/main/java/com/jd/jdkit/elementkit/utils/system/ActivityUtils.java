...
public class ActivityUtils {
    ...
    public static boolean isActivityExists(String packageName, String className) {
        ...
        return !(BaseConfig.application.getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(BaseConfig.application.getPackageManager()) == null ||
                BaseConfig.application.getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void launchActivity(String packageName, String className, Bundle bundle) {
        BaseConfig.application.startActivity(IntentUtils.getComponentIntent(packageName, className, bundle));
    }
    ...
    public static String getLauncherActivity(String packageName) {
        ...
        PackageManager pm = BaseConfig.application.getPackageManager();
