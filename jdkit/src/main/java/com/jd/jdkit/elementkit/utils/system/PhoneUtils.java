...
public class PhoneUtils {
    ...
    public static String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) BaseConfig.application
    ...
    public static void dial(String phoneNumber) {
        BaseConfig.application.startActivity(IntentUtils.getDialIntent(phoneNumber));
    }
    ...
    public static void call(String phoneNumber) {
        BaseConfig.application.startActivity(IntentUtils.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(String phoneNumber, String content) {
        BaseConfig.application.startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content));
    }
    ...
    public static void sendSmsSilent(String phoneNumber, String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(BaseConfig.application, 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = BaseConfig.application.getContentResolver();
