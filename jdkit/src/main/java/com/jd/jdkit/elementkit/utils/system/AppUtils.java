...
public class AppUtils {
    ...
    public static boolean installAppSilent(String filePath) {
        ...
        ShellUtils.CommandResult commandResult = ShellUtils.execCmd(command, !isSystemApp(BaseConfig.application), true);
    ...
    public static void launchApp(String packageName) {
        if (StringUtils.isSpace(packageName)) return;
        BaseConfig.application.startActivity(IntentUtils.getLaunchAppIntent(packageName));
    }
