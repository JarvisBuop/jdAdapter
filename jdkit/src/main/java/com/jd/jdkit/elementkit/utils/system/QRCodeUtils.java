...
//        return null;
    ...
    /**
     * 解析本地图片二维码。该方法是耗时操作，请在子线程中调用。
     *
     * @param picturePath 要解析的二维码图片本地路径
     * @return 返回二维码图片里的内容 或 null
     */
    public static void DecodeQRCode(String picturePath,QRCodeDecodeListener listener) {
        DecodeQRCode(getDecodeAbleBitmap(picturePath),listener);
    }

    /**
     * 解析bitmap二维码。该方法是耗时操作，请在子线程中调用。
     *
     * @param bitmap 要解析的二维码图片
     * @return 返回二维码图片里的内容 或 null
     */
    public static void DecodeQRCode(Bitmap bitmap,QRCodeDecodeListener listener) {
        try {
