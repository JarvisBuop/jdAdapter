...
public class ToastUtil {
	...
	public static void showToast(int resId) {
		showToast(BaseUtils.application.getResources().getString(resId));
	}
	...
	public static void showLongToast( String msg) {
		if (toast==null) {
			toast = Toast.makeText(BaseUtils.application, msg, Toast.LENGTH_LONG);
		}else{
			toast.setText(msg);
	...
	public static void showLongToast(int resId) {
		showLongToast(BaseUtils.application.getResources().getString(resId));
	}
}
