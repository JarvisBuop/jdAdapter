 ...
 * Time: on 2016/8/15 0015:上午 11:22
 * Name:
 * OverView: 汉字->拼音
 * Usage:
 */
public class CharacterParserUtils {
     ...
     * @return
     */
    public String covertChar(String str) {
        StringBuilder result = new StringBuilder();
        for (int i = 0; i < str.length(); i++) {
            String convert = convert(str.substring(i, i + 1));
            result.append(convert.charAt(0));
        }
        LogUtils.i("jarvisclick1", result.toString());
