...
public class ImageLoadManager {
    ...
    public static boolean into(String path, ImageView imageView) {
        if (!TextUtils.isEmpty(path)) {
            Picasso.with(BaseUtils.application)
                    .load(path)
                    .tag(mTAG)
    ...
    public static void pauseLoad() {
        Picasso.with(BaseUtils.application).cancelTag(mTAG);
    }
    ...
    public static void resumeLoad() {
        Picasso.with(BaseUtils.application).resumeTag(mTAG);
    }
...
//                Logger.i("source.getHeight()="+source.getHeight()+",source.getWidth()="+source.getWidth()+",targetWidth="+targetWidth);
    ...
    //    private static volatile ImageLoadManager imageLoadManager = null;
//
//    private ImageLoadManager(Context context) {
//
//    }
//
//    private ImageLoadManager getInstance() {
//        if (imageLoadManager == null) {
//            synchronized (ImageLoadManager.class) {
//                if (imageLoadManager == null) {
//                    imageLoadManager = new ImageLoadManager(App.getInstance());
//                }
//            }
//        }
