...
public class TestLazyFragment2 extends DBaseLazyFragment {
    TextView textView;
    private static String KEY = "key";

    public static TestLazyFragment2 newInstance(String argstr) {
        Bundle args = new Bundle();
        args.putString(KEY, argstr);
        TestLazyFragment2 fragment = new TestLazyFragment2();
