...
public class TestLazyFragment1 extends DBaseLazyFragment {
    TextView textView;
    private static String KEY = "key";

    public static TestLazyFragment1 newInstance(String argstr) {
        Bundle args = new Bundle();
        args.putString(KEY, argstr);
        TestLazyFragment1 fragment = new TestLazyFragment1();
