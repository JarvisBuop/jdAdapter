...
public class TestLazyFragment5 extends DBaseLazyFragment {
    TextView textView;
    private static String KEY = "key";

    public static TestLazyFragment5 newInstance(String argstr) {
        Bundle args = new Bundle();
        args.putString(KEY, argstr);
        TestLazyFragment5 fragment = new TestLazyFragment5();
