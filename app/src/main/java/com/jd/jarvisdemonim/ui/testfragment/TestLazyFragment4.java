...
public class TestLazyFragment4 extends DBaseLazyFragment {
    TextView textView;
    private static String KEY = "key";

    public static TestLazyFragment4 newInstance(String argstr) {
        Bundle args = new Bundle();
        args.putString(KEY, argstr);
        TestLazyFragment4 fragment = new TestLazyFragment4();
